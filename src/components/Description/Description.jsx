      ...
      <div className="description">
        ...
        <div className="about-section">
          ...
          <p>
            ...
            alimentaire, j’ai choisi de me reconvertir dans le développement
            web, un domaine qui m’intéressait déjà lors de mes études en BTS
            Informatique de gestion. Aujourd’hui, je développe mes compétences à
            travers une formation et des projets concrets.
          </p>
        </div>
        {/* SECTION PARCOURS */}
        <div className="journey-section">
          ...
          <p>
            ...
            responsive, soignées et agréables à utiliser. Parmi mes projets,
            Booki représente une étape importante car il s’agit de mon premier
            projet réalisé après plusieurs années sans pratiquer le
            ...
            React. Persévérante et motivée, j’apprécie autant le travail en
            autonomie qu’en équipe. Je recherche aujourd’hui une première
            opportunité pour acquérir de l’expérience et continuer à progresser,
            notamment dans les animations web et le back-end.
          </p>
        </div>
